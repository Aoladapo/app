...
def add_movie():
    ...
    name = input("please provide movie title?: ")
    director = input("please provide movie director?: ")
    year = input("please provide movie release year?: ")
    movies.append({
        'name': name,
        'director': director,
        'year': year
    })
    print('The movies is now added to the movie database')
